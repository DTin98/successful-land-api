 ...
 *     http://175.41.154.174:4000/v1/utilities/search?_limit=5&borders=10.8070851,106.6123851&area_id=5f9ec4e8bfeb451c39403324&category=C%C3%A1c%20c%C3%A2y%20ATM
 *
 *
...
/**
 * @api {get} /v1/utilitie/count Đếm số tiện ích
 * @apiName count
 * @apiGroup utilitieRoutes
 *
 * @apiParam (Query string) {String} _limit Giới hạn tiện ích trả về.
 ...
 *
 * @apiParamExample {json} Request-Example:
 *     http://175.41.154.174:4000/v1/utilities/count?_limit=5&borders=10.8070851,106.6123851&area_id=5f9ec4e8bfeb451c39403324&category=C%C3%A1c%20c%C3%A2y%20ATM
 *
 *
 * @apiSuccessExample Success-Response:
 *     HTTP/1.1 200 OK
